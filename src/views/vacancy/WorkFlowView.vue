      ...
      <TabPanels>
        ...
        <TabPanel>
          <div v-if="showMainPanel">
            <h2 class="mb-4">
              How would you like to evaluate candidate in this stage
            </h2>
            <div class="flex flex-row items-center text-center">
              <div class="items-center text-center border-2 p-6 m-2 rounded">
                <h5 class="my-4 text-lg">Interview kits</h5>
                <AppButton
              ...
              <div class="items-center text-center border-2 p-6 m-2 rounded">
                <h4 class="my-4 text-lg">Assessments</h4>
                <AppButton
